...
export default function CookiePolicy() {
  ...
  return (
    <>
      ...
      >
        <h1 style={{ textAlign: "center" }}>Cookie Policy for Syncpoly</h1>

        <p>
          This is the Cookie Policy for Syncpoly, accessible from
          https://www.syncpoly.com/
        </p>
        ...
        <ul>
          <li>Email: karljohanbailey98@gmail.com</li>
        </ul>
      </Box>
    </>
  );
